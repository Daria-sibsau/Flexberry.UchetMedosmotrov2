...
namespace IIS.UchetMedosmotrov2
{
    ...
    public class СписокНаМедосм : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.UchetMedosmotrov2.DetailArrayOfКонтингентСотр fКонтингентСотр;
        ...
        public virtual IIS.UchetMedosmotrov2.DetailArrayOfКонтингентСотр КонтингентСотр
        {
            get
            {
                ...
                {
                    this.fКонтингентСотр = new IIS.UchetMedosmotrov2.DetailArrayOfКонтингентСотр(this);
                }
                IIS.UchetMedosmotrov2.DetailArrayOfКонтингентСотр result = this.fКонтингентСотр;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СписокНаМедосмE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СписокНаМедосмE", typeof(IIS.UchetMedosmotrov2.СписокНаМедосм));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СписокНаМедосмL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СписокНаМедосмL", typeof(IIS.UchetMedosmotrov2.СписокНаМедосм));
                }
            }
        }
    }
