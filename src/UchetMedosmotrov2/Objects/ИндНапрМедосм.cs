...
namespace IIS.UchetMedosmotrov2
{
    ...
    public class ИндНапрМедосм : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.UchetMedosmotrov2.Сотрудники fСотрудники;
        
        private IIS.UchetMedosmotrov2.Организация fОрганизация;
        
        private IIS.UchetMedosmotrov2.DetailArrayOfВреднФактПроиз fВреднФактПроиз;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.UchetMedosmotrov2.Организация Организация
        {
            get
            {
                ...
                IIS.UchetMedosmotrov2.Организация result = this.fОрганизация;
        ...
        [PropertyStorage(new string[] {
                "Сотрудники"})]
        [NotNull()]
        public virtual IIS.UchetMedosmotrov2.Сотрудники Сотрудники
        {
            get
            {
                ...
                IIS.UchetMedosmotrov2.Сотрудники result = this.fСотрудники;
        ...
        public virtual IIS.UchetMedosmotrov2.DetailArrayOfВреднФактПроиз ВреднФактПроиз
        {
            get
            {
                ...
                {
                    this.fВреднФактПроиз = new IIS.UchetMedosmotrov2.DetailArrayOfВреднФактПроиз(this);
                }
                IIS.UchetMedosmotrov2.DetailArrayOfВреднФактПроиз result = this.fВреднФактПроиз;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ИндНапрМедосмE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИндНапрМедосмE", typeof(IIS.UchetMedosmotrov2.ИндНапрМедосм));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ИндНапрМедосмL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИндНапрМедосмL", typeof(IIS.UchetMedosmotrov2.ИндНапрМедосм));
                }
            }
        }
    }
