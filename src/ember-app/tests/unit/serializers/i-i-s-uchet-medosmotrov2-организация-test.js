...
moduleForModel('i-i-s-uchet-medosmotrov2-организация', 'Unit | Serializer | i-i-s-uchet-medosmotrov2-организация', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-uchet-medosmotrov2-организация',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
